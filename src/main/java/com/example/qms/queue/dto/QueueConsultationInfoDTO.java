...
public class QueueConsultationInfoDTO extends Queue {
    ...
    public QueueConsultationInfoDTO(Queue queue, Optional<Double> averageServeTime) {
        ...
        averageServeTime.ifPresent(average -> this.setAverageServeTime((int) (average * 1000)));
    }
}
